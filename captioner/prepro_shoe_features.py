...
if __name__ == "__main__":
    ...
    parser.add_argument('--image_dir', default='C:\\Users\\23134\\Desktop\\attributedata\\', type=str)
    parser.add_argument('--json_file', default='C:\\Users\\23134\\Desktop\\fashion-retrieval-master/relative_caption_batch123_denoised.json', type=str, help='')
