...
# sys.path.append('neuraltalk2')
# sys.path.append('captioner/neuraltalk2')
# sys.path.append('captioner/neuraltalk2/vis')
# sys.path.append('C:\\Users\\23134\\Desktop\\fashion-retrieval-master\\captioner\\neuraltalk2\\misc')
